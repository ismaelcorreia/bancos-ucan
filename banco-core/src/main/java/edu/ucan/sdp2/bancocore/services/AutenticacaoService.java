...
import edu.ucan.sdp2.bancocore.configuration.security.JWTUtil;
...
import edu.ucan.sdp2.bancocore.dto.respostas.UtilizadorLoginRespostaDto;
...
import edu.ucan.sdp2.bancocore.mapper.UtilizadorMapper;
...
public class AutenticacaoService {
    ...
    public ResponseEntity<Resposta> autoRegistoCliente(UtilizadorAutoRegistoDto request) {
        ...
        autorizacaoService.requisitarActivacaoConta(userSaved.getTelefone());
